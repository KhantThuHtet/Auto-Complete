...
const navigateAndSelectProduct = (key) => {
  if (key == "ArrowDown") {
    ...
    console.log(productIdToShow.textContent);
  }
};


buildUi(productData);
const productToDeselect = () =>{
  let selectedProduct = document.querySelector(".selected");
  selectedProduct.style.backgroundColor = "#413E39";
